    ...
    <div className="flex flex-col min-h-screen bg-[#DAEDF2] font-ubuntu">
      ...
      <header className="bg-[#0092BC] text-white p-6">
        <div className="flex justify-between items-center mx-auto">
          ...
          <div>
            <a href="/roomies" className="bg-[#A3D9D3] text-[#0092BC] px-8 py-3 rounded mr-5 font-bold italic text-lg hover:bg-[#0092BC] transition duration-300">
              Roomies
            </a>
            <a href="/profile" className="bg-[#A3D9D3] text-[#0092BC] px-8 py-3 rounded mr-5 font-bold italic text-lg hover:bg-[#0092BC] transition duration-300">
              Perfil
            </a>
            <a href="main" className="bg-[#A3D9D3] text-[#0092BC] px-8 py-3 rounded mr-5 font-bold italic text-lg hover:bg-[#0092BC] transition duration-300">
              Volver
            </a>
