    ...
    return (
        <div className="h-screen">
            ...
            <div className="flex h-[calc(100vh-80px)]">
                ...
                <Link to="/descuentos" className="flex-1 flex flex-col justify-start items-center bg-[#DAEDF2] text-[#333] text-center transition duration-300 ease-in-out hover:bg-gray-800 p-8">
